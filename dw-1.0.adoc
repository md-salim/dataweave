...
* link:https://blogs.mulesoft.com/dev/anypoint-studio-dev/getting-started-with-dataweave-part-1[getting-started-with-dataweave-part-1]
* link:https://blogs.mulesoft.com/dev/getting-started-with-dataweave-part-2[getting-started-with-dataweave-part-2]
* link:https://blogs.mulesoft.com/dev/getting-started-with-dataweave-part-3[getting-started-with-dataweave-part-3]
* link:https://blogs.mulesoft.com/dev/getting-started-with-dataweave-part-4[getting-started-with-dataweave-part-4]
